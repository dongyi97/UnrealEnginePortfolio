...
void AWeaponBase::Interact_Implementation(AMyCharacter* Character)
{
	...
	if (Character->WeaponSlots[Character->CurrentWeaponSlot] == nullptr)
	{
		...
		//////////////////////////////////////////////
		this->bodyMeshComp->AttachToComponent(Character->GetMesh(), FAttachmentTransformRules::SnapToTargetNotIncludingScale, TEXT("WeaponSocket"));
		this->bodyMeshComp->SetRelativeLocation(FVector(-17, 10, -3));
		this->bodyMeshComp->SetRelativeRotation(FRotator(0, 90, 0));
...
void AWeaponBase::Fire()
{
	...
	{
		startPos = tmpCharacter->fpsCamComp->GetComponentLocation();
		endPos = tmpCharacter->fpsCamComp->GetComponentLocation() + tmpCharacter->fpsCamComp->GetForwardVector() * 5000;
	}
